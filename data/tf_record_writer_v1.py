...
import sys
from preprocess_data import get_music_data
import os
...
def main():
    ...
    training_set=get_music_data()

    for data_set, name, dir_ in zip([training_set], ['train', 'test'], [TF_RECORD_TRAIN_PATH, TF_RECORD_TEST_PATH]):
